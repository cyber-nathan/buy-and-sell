...
export let FILTER_ITEM_DATA: FilterItem[] = [
  {
    filterName: "University Tools",
    children: [ {filterName: "Textbook"}, {filterName: "Equipment" }]
  },
  {
    filterName: "Clothes",
    children: [ {filterName: "Men"}, {filterName: "Equipment" }]
  },
]
